...
2. Update the integration test files with the latest minor version:
    ...
    * https://github.com/canonical/cluster-api-k8s/blob/5a9807e/test/e2e/config/ck8s-incus.yaml#L52
    * https://github.com/canonical/cluster-api-k8s/blob/5a9807e/test/e2e/config/ck8s-incus.yaml#L63
